...
|--------|-------------|------|
| cli | Top-level command surface — root, update, shell-init, version | [commands](cli/commands.md), [update](cli/update.md), [shell-init](cli/shell-init.md), [version](cli/version.md) |
