...
| `install.go` *(extended by bb7r)* | `newInstallCmd()` + `runInstall` + `shllSelfInstallNote` (`"shll — already present / self-managed"`, change bb7r — the prepended shll-first informational line). See [install](/cli/install.md). |
